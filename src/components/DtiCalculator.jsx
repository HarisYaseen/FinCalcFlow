        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="bg-amber-50/90 border border-amber-200/90 p-5 rounded-2xl text-xs text-amber-950 shadow-sm leading-relaxed space-y-2 text-left">
            <div className="flex items-center gap-2 font-extrabold text-amber-900 uppercase tracking-wider">
              ...
              <span>Legal & Underwriting Educational Disclaimer</span>
            </div>
            <p>
              This Debt-to-Income (DTI) calculator is engineered strictly for educational estimation and mortgage underwriting scenario modeling. Calculated front-end and back-end DTI ratios, maximum qualifying loan estimates, and risk categories are mathematical estimations based on Fannie Mae, Freddie Mac, and FHA guidelines. This tool does not constitute official mortgage pre-approval, credit decisioning, or financial advice. Actual lender qualification guidelines vary based on loan product (FHA, VA, Conventional), credit score, cash reserves, and automated underwriting system (AUS) approval. Consult a certified mortgage loan officer (MLO) or CFP.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-1.5 flex-1">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="px-2.5 py-0.5 bg-amber-100 text-amber-800 text-[11px] font-extrabold rounded-full">
                  Underwriting & Risk Systems Specialist
                </span>
              </div>
              <p className="text-xs text-slate-600 leading-relaxed">
                Verified by FinCalc Flow's Finance Engineering Team. Written and mathematically audited for accuracy against Consumer Financial Protection Bureau (CFPB) Qualified Mortgage (QM) rules and Federal Housing Administration (FHA) DTI thresholds.
              </p>
