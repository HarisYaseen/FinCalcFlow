        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="bg-amber-50/90 border border-amber-200/90 p-5 rounded-2xl text-xs text-amber-950 shadow-sm leading-relaxed space-y-2 text-left">
            <div className="flex items-center gap-2 font-extrabold text-amber-900 uppercase tracking-wider">
              ...
              <span>Legal & Auto Finance Educational Disclaimer</span>
            </div>
            <p>
              This auto loan calculator is engineered strictly for educational estimation and monthly budget planning purposes. Calculated monthly payments, sales tax credits, dealer doc fees, and total interest charges are mathematical estimations. This tool does not constitute a formal dealer financing quote, credit approval, or binding automotive sales contract. Actual APRs, dealer documentation fees, and loan terms vary based on dealership financing departments, credit score, vehicle year, and lender underwriting. Consult a licensed auto lender or F&I manager before signing vehicle purchase contracts.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-1.5 flex-1">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="px-2.5 py-0.5 bg-indigo-100 text-indigo-800 text-[11px] font-extrabold rounded-full">
                  Automotive Finance Systems Specialist
                </span>
              </div>
              <p className="text-xs text-slate-600 leading-relaxed">
                Verified by FinCalc Flow's Finance Engineering Team. Written and mathematically audited for accuracy against Consumer Financial Protection Bureau (CFPB) auto financing guidelines, state trade-in tax credit formulas, and standard vehicle amortization algorithms.
              </p>
